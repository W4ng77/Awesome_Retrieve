...
def load_hotpotqa_subset(split="test", num_samples=200, embedding_model="sentence-transformers/all-MiniLM-L6-v2", return_gold=True):
    ...
    for example in ds:
        ...
        context_chunks = chunk_text(context, tokenizer, max_tokens=16)
